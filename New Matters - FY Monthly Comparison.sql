-- New Matters - FY Monthly Comparison
...
(
    ...
    count(id) as new_matters
    from {{#635-firm-files-id-offering-id}} as new_matters
    where status_id in (4, 5, 6) -- Won matters only (Open, Closed, Finalised)
...
END as fy_month,
fyyear,
sum(new_matters) as total_new_matters
from main
where 1=1
